...
class RequestContext:
    def __init__(self, trace_id: str = None):
        ...
        try:
            from src.utils.clean_up import check_disk_space
        ...
        try:
            from src.utils.clean_up import register_for_cleanup
    ...
    def cleanup(self):
        ...
        if os.path.exists(self.sandbox_path):
            try:
                ...
                # Optional unregister
                try:
                    from src.utils.clean_up import unregister_for_cleanup
                    unregister_for_cleanup(self.sandbox_path)
                except:
                    pass
