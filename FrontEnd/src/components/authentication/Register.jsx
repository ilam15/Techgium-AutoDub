...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 font-sans">
            <div className="max-w-md w-full bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 p-8 sm:p-10 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
                ...
                <div className="space-y-5">
                    <div>
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                ref={username}
                                className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-gray-900 focus:ring-1 focus:ring-gray-900 focus:bg-white transition-all duration-200 ease-in-out"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                ref={password}
                                className="w-full pl-10 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-gray-900 focus:ring-1 focus:ring-gray-900 focus:bg-white transition-all duration-200 ease-in-out"
                            />
                            <button
                                type="button"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button type="button" onClick={() => toast.info("Google Login Coming Soon!")} className="flex items-center justify-center px-4 py-2.5 border border-gray-200 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors duration-200 active:bg-gray-200">
                        ...
                        <button type="button" onClick={() => toast.info("GitHub Login Coming Soon!")} className="flex items-center justify-center px-4 py-2.5 border border-gray-200 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors duration-200 active:bg-gray-200">
