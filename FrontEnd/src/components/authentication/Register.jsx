...
const Register = () => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm font-sans pt-12 sm:pt-20 lg:pt-24 h-full overflow-y-auto" onClick={handleBackdropClick}>

            <div className="max-w-md w-full bg-white/90 backdrop-blur-xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/50 p-8 sm:p-10 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.16)] relative z-10 mx-4 my-8">
