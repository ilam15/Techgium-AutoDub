...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-md w-full bg-white/90 backdrop-blur-xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/50 p-8 sm:p-10 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.16)] relative z-10 mx-4">
